...
// #include "instrument_adapter/instrument_adapter_interface.h"
#include "instrument_adapter/instrument_data_formatter_interface.h"
#include "instrument_adapter/instrument_reader_interface.h"
